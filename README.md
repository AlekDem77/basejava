...
## Разработка Web приложения "База данных резюме"
  ...
  - хранение резюме
     ...
     -  в файловой системе (File API и <a href="http://www.quizful.net/post/java-nio-tutorial">Java 7 NIO File API</a>)
        ...
        - в формате XML (<a href="https://src.ru.wikipedia.org/wiki/Java_Architecture_for_XML_Binding">JAXB</a>)
     -  в реляционной базе <a href="https://src.ru.wikipedia.org/wiki/PostgreSQL">PostgreSQL</a>
...
[*— Илон Маск](https://src.ru.wikipedia.org/wiki/Маск,_Илон)
...
## Программа
### [Регистрация](http://javaops.src.ru/reg/basejava)
### Открытое занятие 1
...
- <a href="https://habrahabr.src.ru/post/153373/">Книги по Java: от новичка до профессионала</a>
...
- <a href="http://www.labirint.src.ru/books/87603/">Гамма, Хелм, Джонсон: Приемы объектно-ориентированного проектирования. Паттерны проектирования</a>
- <a href="http://www.bookvoed.src.ru/book?id=639284">Редмонд Э.: Семь баз данных за семь недель. Введение в современные базы данных и идеологию NoSQL.</a>
...
- <a href="http://www.intuit.src.ru/studies/courses/16/16/info">intuit: Программирование на Java</a>
- <a href="http://sernam.src.ru/book_java.php">Основы программирования на Java: учебное пособие</a>
